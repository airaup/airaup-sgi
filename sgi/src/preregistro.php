<?php
	...
	if ($accion == "aceptar"){
		...
		$tpl->assign("mensaje", utf8_encode("Te enviamos un mail para confirmar tu dirección de correo y continuar el registro. Por favor revisa tu carpeta de spam en caso de no recibir el mensaje en tu bandeja de entrada."));
	} else if ($accion == "fe"){
		$tpl->newBlock("mensaje");
		$tpl->assign("mensaje", utf8_encode("Quedaste registrado pero ocurrió un error al enviar el correo de confirmación. Por favor comunicate con tu Presidente."));
	} else {
