...
if ($id != "") {
    ...
    if ($buscar['idTransaccion'] != "") {
        ...
        $tpl->Assign("mensaje", utf8_encode("Ocurri� un error en la transacci�n, por favor intentalo nuevamente o comunicate con un administrador del sistema."));
    }
