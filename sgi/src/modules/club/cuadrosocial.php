    ...
    if ($accion == "activarS") {
        ...
        while ($cargosDistrito=$conexion->Siguiente()) {
            if ($cargosDistrito['Nombre'] == 'Representante Distrital') {
                ...
                break;
            } elseif ($cargosDistrito['Nombre'] == 'Administrador') {
                $Administrador= true;
        ...
        } elseif ($datosSocio['Admin'] == 2 || $representante || $adminEventos['Cantidad'] > 0 || $presidenteA['idSocio'] == $logueado) {
            $tpl->newBlock("menuEventos");
        }
        ...
        while ($socios=$conexion->Siguiente()) {
            ...
            if ($socios['Admin'] == 0) {
                $tpl->assign("admin", "NO");
            } elseif ($socios['Admin'] == 1) {
                $tpl->assign("admin", "SI");
            } elseif ($socios['Admin'] == 2) {
                $tpl->assign("admin", "SI");
            }

            if ($socios['Activo'] == 0) {
                $tpl->assign("activo", "NO");
            } elseif ($socios['Activo'] == 1) {
